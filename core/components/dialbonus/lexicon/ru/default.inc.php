<?php
$_lang['dialbonus'] = 'Бонусная система';
$_lang['dialbonus.desc'] = 'Страница бонусной системы';
$_lang['dialbonus.management'] = 'Страница бонусной системы';
$_lang['search'] = 'Поиск';
$_lang['edit'] = 'Изменить';
$_lang['remove'] = 'Удалить';
$_lang['remove_confirm'] = 'Удаление записи';
...
$_lang['dialbonus.balance_update'] = 'Изменение баланса ';
