<?php  return array (
  ...
  'setting_ms2_yandex_apikey' => 'Секретный ключ Яндекс.Кассы',
  'setting_ms2_yandex_api_url' => 'URL api запросов Яндекс.Кассы',
  'setting_ms2_yandex_return_url' => 'URL возврата Яндекс.Кассы',
  'setting_ms2_yandex_return_url_desc' => 'URL, на который вернется пользователь после подтверждения или отмены платежа.',
  'setting_ms2_yandex_shopid' => 'Идентификатор магазина Яндекс.Кассы',
);