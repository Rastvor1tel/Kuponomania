<?php  return array (
  ...
  array (
    ...
    'cacheable' => 1,
    'createdby' => 1,
    'createdon' => 1562682231,
    'editedby' => 1,
    'editedon' => 1562688094,
    'deleted' => 0,
    'deletedon' => 0,
    'deletedby' => 0,
    'publishedon' => 1562683020,
    'publishedby' => 1,
    'menutitle' => '',
    'donthit' => 0,
    'privateweb' => 0,
...
{block \'content\'}
<div class="global-layout catalog-layout">
    {\'pdoPage\' | snippet : [
        \'tpl\' => \'@FILE chunks/MiniShop/productsTpl.tpl\',
        \'element\' => \'msProducts\'
    ]}
</div>
{/block}',
    ...
    '_sjscripts' => 
    array (
      0 => '<link rel="canonical" href="http://kuponomania.localhost/katalog/vse-akczii/"/>',
    ...
    '_loadedjscripts' => 
    array (
      '<link rel="canonical" href="http://kuponomania.localhost/katalog/vse-akczii/"/>' => true,
    ...
    <div class="promotion-teaser">
        ...
        <form method="post" class="ms2_form promotion-teaser__content">
            <div class="promotion-teaser-content">
                ...
                <a href="katalog/krasota/skidka-50-na-uslugi-v-studii-ekspress-manikyura-kivi/" style="height: 15%; color: #4a4a4a;">Скидка 50% на услуги в студии экспресс-маникюра "КИВИ"</a>
                <span class="flags">
                                                                            </span>
            </div>
...
<div class="row ms2_product">
    <div class="promotion-teaser">
        <a href="katalog/tovaryi/uslugi/skidka-50-na-foto-uslugi-nikolaya-dolgopolova/" class="promotion-teaser__image">
                            <img class="coupon_avatar" src="/assets/images/products/15/small/header.jpg" data-echo="/assets/images/products/15/header.jpg" alt="Скидка 50% на фото-услуги Николая Долгополова" title="Скидка 50% на фото-услуги Николая Долгополова"/>
                    </a>
        <form method="post" class="ms2_form promotion-teaser__content">
            <div class="promotion-teaser-content">
                ...
                <input type="hidden" name="count" value="1">
                <input type="hidden" name="options" value="[]">
                <a href="katalog/tovaryi/uslugi/skidka-50-na-foto-uslugi-nikolaya-dolgopolova/" style="height: 15%; color: #4a4a4a;">Скидка 50% на фото-услуги Николая Долгополова</a>
                <span class="flags">
                                                                            </span>
            </div>
            <div class="promotion-teaser__price">
                <div class="promotion-teaser-footer">
                    ...
                    <div class="promotion-teaser-footer-col promotion-teaser-footer-col--link">
                        <div class="new-price-teaser">
                            0<span style="font-size:20px;">руб.</span>
                        </div>
                    </div>
                </div>
            </div>
